...
class AlarmListAdapter extends BaseAdapter
{
  ...
  public View getView(int position, View convertView, ViewGroup parent)
  {
    ...
    if (convertView == null)
    {
      ...
      holder.iconBell = (ImageView)convertView.findViewById(R.id.iconBell);
    ...
    holder.iconBell.setImageResource(alarm.getEnabled() ? R.drawable.ic_bell_on : R.drawable.ic_bell_off);
